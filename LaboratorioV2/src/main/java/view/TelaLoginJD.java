 ...
 * @author andre
 */
public class TelaLoginJD extends javax.swing.JFrame {

    /**
     * Creates new form TelaLoginJD
     */
    public TelaLoginJD() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPasswordField1.setSelectionColor(new java.awt.Color(0, 102, 102));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaLoginJD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaLoginJD().setVisible(true);
            }
        });
    }
